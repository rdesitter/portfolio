        ...
        <div className={`project ${theme} project--ballman`}>
            ...
            <div className="project__banner project__banner--ballman">
                ...
                <div className="slider__item__content">
                    ...
                    <h2 className="project__banner__title" data-color={theme}>Lords of Meta</h2>
            ...
            <div className="container">
                <div className="project__section">
                    ...
                    <p>LOM est un projet lancé en novembre 2021 en collaboration avec le joueur de tennis Stanislas Wawrinka. Il s'agit d'une collection de 5 555 NFT uniques à son effigie, permettant à moyen terme de participer à des tournois de tennis virtuels, les NFT Open Series.</p>
                </div>
            </div>
